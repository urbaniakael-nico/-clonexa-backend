...
# remove previous references script if any
html = re.sub(
    r'\s*<script[^>]+src=["\'][^"\']*client_references_v1[^"\']*["\'][^>]*>\s*</script>\s*',
    "\n",
    html,
    flags=re.IGNORECASE,
)

tag = '<script src="/client-static/client_references_v1.js?v=REF02_20260509"></script>'
