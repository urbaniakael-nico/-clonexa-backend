...
# Insertar justo después de client_core_settings.js
...
if matches:
    ...
    repair_src = re.sub(
        ...
        'client_core_settings_i18n_safe.js?v=020OR1',
        src
    )
    html = html[:last.end()] + f'\n<script src="{repair_src}"></script>\n' + html[last.end():]
else:
    html = html.replace("</body>", '<script src="/client-static/client_core_settings_i18n_safe.js?v=020OR1"></script>\n</body>')

html_path.write_text(html, encoding="utf-8")

print("PATCH_OK: 020O-R1 Core Settings i18n repair added")
